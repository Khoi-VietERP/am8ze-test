odoo.define('wk39717700c_modifier_report.InvoiceSummaryProduct', function (require) {
    'use strict';
    ...
    var _t = core._t;
    var exports = {};
    var InvoiceSummaryProduct = AbstractAction.extend({
        template: 'TempInvoiceSummaryProduct',
        events: {
        ...
        plot_data: function (initial_render = true) {
            ...
            self._rpc({
                ...
                if (initial_render) {
                    self.$('.py-control-panel').html(QWeb.render('FilterInvoiceSummaryProduct', {get_info: datas}));
                    self.$el.find('.user-multiple').select2({
                        placeholder: 'Select Salesman...',
                    });
                }
                self.$('.py-data-container-orig').html(QWeb.render('TempInvoiceSummaryProductMain', {
                    get_info: datas,
                }));
        ...
        print_pdf: function (e) {
            ...
            self._rpc({
                ...
                action['context'] = {
                    'active_model': 'report.invoice.summary.product',
    ...
    core.action_registry.add('report.invoice.summary.product', InvoiceSummaryProduct);

    return {
        InvoiceSummaryProduct: InvoiceSummaryProduct,
    };
});
