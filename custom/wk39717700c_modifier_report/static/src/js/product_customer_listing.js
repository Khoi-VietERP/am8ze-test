odoo.define('wk39717700c_modifier_report.ProductCustomerListing', function (require) {
    'use strict';
    ...
    var _t = core._t;
    var exports = {};
    var ProductCustomerListing = AbstractAction.extend({
        template: 'TempProductCustomerListing',
        events: {
        ...
        plot_data: function (initial_render = true) {
            ...
            self._rpc({
                ...
                if (initial_render) {
                    self.$('.py-control-panel').html(QWeb.render('FilterProductCustomerListing', {get_info: datas}));
                    self.$el.find('.product-multiple').select2({
                        maximumSelectionSize: 1,
                        placeholder: 'Select Product...',
                    });
                }
                self.$('.py-data-container-orig').html(QWeb.render('TempProductCustomerListingMain', {
                    get_info: datas,
                }));
        ...
        print_pdf: function (e) {
            ...
            self._rpc({
                ...
                action['context'] = {
                    'active_model': 'report.product.customer.listing',
    ...
    core.action_registry.add('report.product.customer.listing', ProductCustomerListing);

    return {
        ProductCustomerListing: ProductCustomerListing,
    };
});
