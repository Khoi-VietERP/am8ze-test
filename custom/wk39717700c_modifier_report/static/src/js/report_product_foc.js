odoo.define('wk39717700c_modifier_report.ReportProductFoc', function (require) {
    'use strict';
    ...
    var _t = core._t;
    var exports = {};
    var ReportProductFoc = AbstractAction.extend({
        template: 'TempReportProductFoc',
        events: {
        ...
        plot_data: function (initial_render = true) {
            ...
            self._rpc({
                ...
                if (initial_render) {
                    self.$('.py-control-panel').html(QWeb.render('FilterReportProductFoc', {get_info: datas}));
                }
                self.$('.py-data-container-orig').html(QWeb.render('TempReportProductFocMain', {
                    get_info: datas,
                }));
        ...
        print_pdf: function (e) {
            ...
            self._rpc({
                ...
                action['context'] = {
                    'active_model': 'product.foc.report',
    ...
    core.action_registry.add('product.foc.report', ReportProductFoc);

    return {
        ReportProductFoc: ReportProductFoc,
    };
});
