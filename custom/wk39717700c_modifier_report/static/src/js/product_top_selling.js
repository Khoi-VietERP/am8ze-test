odoo.define('wk39717700c_modifier_report.ProductTopSelling', function (require) {
    'use strict';
    ...
    var _t = core._t;
    var exports = {};
    var ProductTopSelling = AbstractAction.extend({
        template: 'TempProductTopSelling',
        events: {
        ...
        plot_data: function (initial_render = true) {
            ...
            self._rpc({
                ...
                if (initial_render) {
                    self.$('.py-control-panel').html(QWeb.render('FilterProductTopSelling', {get_info: datas}));
                }
                self.$('.py-data-container-orig').html(QWeb.render('TempProductTopSellingMain', {
                    get_info: datas,
                }));
        ...
        print_pdf: function (e) {
            ...
            self._rpc({
                ...
                action['context'] = {
                    'active_model': 'report.product.top.selling',
    ...
    core.action_registry.add('report.product.top.selling', ProductTopSelling);
