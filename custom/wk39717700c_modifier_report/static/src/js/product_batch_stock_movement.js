odoo.define('wk39717700c_modifier_report.ProductBatchStockMovement', function (require) {
    'use strict';
    ...
    var _t = core._t;
    var exports = {};
    var ProductBatchStockMovement = AbstractAction.extend({
        template: 'TempProductBatchStockMovement',
        events: {
        ...
        plot_data: function (initial_render = true) {
            ...
            self._rpc({
                ...
                if (initial_render) {
                    self.$('.py-control-panel').html(QWeb.render('FilterProductBatchStockMovement', {get_info: datas}));
                    self.$el.find('.location-multiple').select2({
                        maximumSelectionSize: 1,
                        placeholder: 'Select Location...',
                    });
                }
                self.$('.py-data-container-orig').html(QWeb.render('TempProductBatchStockMovementMain', {
                    get_info: datas,
                }));
        ...
        print_pdf: function (e) {
            ...
            self._rpc({
                ...
                action['context'] = {
                    'active_model': 'product.batch.stock.movement',
    ...
    core.action_registry.add('product.batch.stock.movement', ProductBatchStockMovement);

    return {
        ProductBatchStockMovement: ProductBatchStockMovement,
    };
});
