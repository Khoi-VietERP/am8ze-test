...
var PreviewContentVideo = AbstractPreviewContent.extend({
    ...
    mimetypeMap: {
		'.mp4': 'video/mp4', '.webm': 'video/webm', '.ogg': 'video/ogg', '.mov': 'video/mov',
		'mp4': 'video/mp4', 'webm': 'video/webm', 'ogg': 'video/ogg', 'mov': 'video/mov',
	},
...
_.each(['.mp4', '.webm', '.ogg', '.mov'], function(extension) {
	registry.add(extension, PreviewContentVideo);
});
_.each(['mp4', 'webm', 'ogg', 'mov'], function(extension) {
	registry.add(extension, PreviewContentVideo);
});
_.each(['video/mp4', '	video/webm', 'video/ogg', 'video/mov'], function(mimetype) {
