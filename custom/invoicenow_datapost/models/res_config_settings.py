...
class ResConfigSettings(models.TransientModel):
    ...
    module_datapost = fields.Boolean('InvoiceNow Integration', default=False)
    datapost_uri = fields.Char('InvoiceNow URI', default='https://peppol.datapost.com.sg/services/rest/peppol')
    datapost_version = fields.Selection([
        ('v10', '1.0')
    ], 'InvoiceNow API Version')
    datapost_username = fields.Char('InvoiceNow API Key', default='')
    datapost_password = fields.Char('InvoiceNow Secret', default='')
