odoo.define('alphabricks_pnl_report.PnlReport', function (require) {
    'use strict';
    ...
    var _t = core._t;
    var exports = {};
    var PnlReport = AbstractAction.extend({
        template: 'TempPnlReport',
        events: {
            'click #filter_apply_button': 'update_with_filter',
            'click #pdf': 'print_pdf',
            'click #pdf-landscape': 'print_pdf_landscape',
            'click #xlsx': 'print_xlsx',
            'click .line-account': 'view_account_move',
        },
        ...
        plot_data: function (initial_render = true) {
            ...
            self._rpc({
                ...
                if (initial_render) {
                    self.$('.py-control-panel').html(QWeb.render('FilterPnlReport', {get_info: datas}));
                ...
                self.$('.py-data-container-orig').html(QWeb.render('TempPnlReportMain', {
                    get_info: datas,
                }));
        ...
        print_pdf: function (e) {
            ...
            self._rpc({
                ...
                action['context'] = {
                    'active_model': 'pnl.report',
                    'active_id': self.wizard_id,
                }
                return self.do_action(action);
            });
        },
        print_pdf_landscape: function (e) {
            e.preventDefault();
            var self = this;
            self._rpc({
                model: 'pnl.report',
    ...
    core.action_registry.add('pnl.report', PnlReport);
