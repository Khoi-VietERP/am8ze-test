...
class history_register_of_directors(models.Model):
    _name = 'history.register.of.directors'
    ...
    usual_residential_address = fields.Char(string="Usual residential address or registered or principle office of corporation")
