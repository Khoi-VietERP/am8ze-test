odoo.define('wk39717700c_modifier_print.SalesmanInvoiceDetailReport', function (require) {
    'use strict';
    ...
    var SalesmanInvoiceDetailReport = AbstractAction.extend({
        template: 'TempSalesmanInvoiceDetailReport',
        events: {
        ...
        plot_data: function (initial_render = true) {
            ...
            self._rpc({
                ...
                if (initial_render) {
                    self.$('.py-control-panel').html(QWeb.render('FilterSalesmanInvoiceDetailReport', {get_info: datas}));
                ...
                self.$('.py-data-container-orig').html(QWeb.render('TempSalesmanInvoiceDetailReportMain', {
                    get_info: datas,
                }));
        ...
        print_pdf: function (e) {
            ...
            self._rpc({
                ...
                action['context'] = {
                    'active_model': 'salesman.invoice.detail',
    ...
    core.action_registry.add('salesman.invoice.detail', SalesmanInvoiceDetailReport);

    return {
        SalesmanInvoiceDetailReport: SalesmanInvoiceDetailReport,
    };
});
