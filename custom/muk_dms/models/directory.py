...
class Directory(models.Model):
    ...
    directory_history_ids = fields.One2many('muk_dms.directory.history','directory_id')
...
class directory_history(models.Model):
    _name = 'muk_dms.directory.history'

    name = fields.Char(string='Name')
    description = fields.Char(string='Description')
    directory_id = fields.Many2one('muk_dms.directory')
