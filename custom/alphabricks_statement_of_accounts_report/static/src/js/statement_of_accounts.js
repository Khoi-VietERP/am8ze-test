odoo.define('wk39717700c_modifier_print.StatementOfAccounts', function (require) {
    'use strict';
    ...
    var StatementOfAccountsReport = AbstractAction.extend({
        template: 'TempStatementOfAccountsReport',
        events: {
        ...
        plot_data: function (initial_render = true) {
            ...
            self._rpc({
                ...
                if (initial_render) {
                    self.$('.py-control-panel').html(QWeb.render('FilterStatementOfAccountsReport', {get_info: datas}));
                }
                self.$('.py-data-container-orig').html(QWeb.render('TempStatementOfAccountsReportMain', {
                    get_info: datas,
                }));
        ...
        print_pdf: function (e) {
            ...
            self._rpc({
                ...
                action['context'] = {
                    'active_model': 'statement.of.accounts.report',
    ...
    core.action_registry.add('statement.of.accounts.report', StatementOfAccountsReport);

    return {
        StatementOfAccountsReport: StatementOfAccountsReport,
    };
});
