...
class DatapostResponse(models.Model):
    ...
    def _generate_document_data(self):
        ...
        company_peppol_id_parts = company_peppol_name.name.split(':')
    ...
    <ApplicationResponse xmlns="urn:oasis:names:specification:ubl:schema:xsd:ApplicationResponse-2"
    	...
    	<cac:SenderParty>
    		...
    		<cac:PartyLegalEntity>
    			<cbc:RegistrationName>{company_peppol_company_name}</cbc:RegistrationName>
    		</cac:PartyLegalEntity>
    		<cac:Contact>
    	...
    	<cac:DocumentResponse>
    		...
    		<cac:IssuerParty>
    			...
    			<cac:PartyName>
    				<cbc:Name>{company_peppol_company_name}</cbc:Name>
    			</cac:PartyName>
    		</cac:IssuerParty>
    	</cac:DocumentResponse>
    </ApplicationResponse>'''
