...
class InsFinancialReportXlsx(models.AbstractModel):
    ...
    def generate_xlsx_report(self, workbook, data, record):
        ...
        merge_cells = 3
        if data['form']['enable_month_year_comp']:
            if data['form']['used_context'].get('period', False):
                merge_cells = data['form']['used_context'].get('period', False)

        self.sheet.merge_range(0, 0, 0, merge_cells, data['form']['account_report_id'][1] +' - '+data['form']['company_id'][1], self.format_title)
