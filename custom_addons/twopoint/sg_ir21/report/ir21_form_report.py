        ...
        for employee in emp_ids:
            ...
            if payslip_id:
                ...
                res['salary_period'] = payslip_id.date_from.strftime(
                    DSDF) + ' To ' + payslip_id.date_to.strftime(DSDF)
            ...
            res['birthday'] = employee.birthday or ''
...
#            res['country_id'] = employee.country_id or ''
            ...
            res['app_date'] = employee.app_date or ''
            res['join_date'] = employee.join_date or ''
            res['cessation_date'] = employee.cessation_date or ''
            res['last_date'] = employee.last_date or ''
            ...
            res['marriage_date'] = employee.marriage_date or ''
...
#            res['cmp_street2'] = employee.address_id.street2 or ''
            ...
            for dependent in employee.dependent_ids:
                ...
                if dependent.relation_ship == 'son' or \
                    ...
                    child['child_gender'] = dependent.relation_ship
                    child['birth_date'] = dependent.birth_date
                child_list.append(child)
            res['child'] = child_list
            for history in employee.history_ids:
                res['cessation_date'] = history.cessation_date or ''
