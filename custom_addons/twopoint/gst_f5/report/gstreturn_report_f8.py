...
class report_gst_returnf8(models.AbstractModel):
    _name = 'report.gst_f5.gst_return_report_f8'
    ...
    def render_html(self, docids, data):
        ...
        return self.env['report'].render('gst_f5.gst_return_report_f8', docargs)
