    ...
    def get_info(self, form):
        ...
        if move_lines and move_lines.ids:
            ...
            for move in move_lines:
                ...
                # if srca_bool:
                #     print(">>>>>>>>>>>>>> in bool trueeeeeeeeee", srca_bool)
                ...
                # print(">>>>>>>>>>>> sum_credit_box1",sum_credit_box1)
                # print(">>>>>>>>>>>> sum_debit_box1", sum_debit_box1)
                # print(">>>>>>>>>>>> sum_credit_box1", sum_credit_box1)
                # print(">>>>>>>>>>>> sum_debit_box1", sum_debit_box1)
        ...
        ## BOX 1 Duplicate SR
        tax_ids_box1_1 = account_tax.search(create_code_domain_dup(['SR_DUP']))
        ...
        ## BOX 5
        tax_ids_box5 = account_tax.search([('name', 'in', ['Purchase Tax 7% TX-E33','Purchase Tax 7% TX-N33',
                                                           'Purchase Tax 7% TX-RE','Purchase Tax 7% TX7','Purchase Tax 0% ZP','Purchase Tax 7% IM',
                                                           'Purchase Tax 0% ME','Purchase Tax 7% IGDS','Purchase Tax 7% TXCA'
                                                            ])])
