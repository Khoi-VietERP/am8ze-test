...
class ir8s_form(models.AbstractModel):
    ...
    def get_data(self, form):
        ...
        if start_date and end_date:
            year = datetime.strptime(start_date, DSDF).year
            start_year = datetime.strptime(start_date, DSDF).year - 1
            end_year = datetime.strptime(end_date, DSDF).year - 1
        ...
        for contract in contract_rec:
            ...
            for contract_income_tax in income_tax_rec:
                ...
                if employee_id.birthday:
                    birthday = datetime.strptime(employee_id.birthday, DSDF)
